      ...
      <SafeAreaView style={styled.auth}>
        ...
        >
          ...
          <View style={styled.auth__buttons}>
            ...
            />
            <BtnButton onPress={() => navigation.navigate("Email")} title={t("registration")} buttonStyle={{ marginTop: isShowKeyboard ? 5 : 15, marginBottom: isShowKeyboard ? 5 : 20 }} textStyle={{ color: "black" }} />
          </View>
        </KeyboardAvoidingView>
      </SafeAreaView>
    </ScrollView>
